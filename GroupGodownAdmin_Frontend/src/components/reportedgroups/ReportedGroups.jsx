                          ...
                          return (
                            <tr key={index}>
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
                                {reportedGroups.groupName}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
                                <a className="text-black" href={reportedGroups.groupLink} target="_blank" rel="noopener noreferrer">{reportedGroups.groupLink}</a>
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
                                {reportedGroups.country}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
                                {reportedGroups.Language}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
                                {reportedGroups.Category.catName}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
                                {reportedGroups.Application.appName}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
