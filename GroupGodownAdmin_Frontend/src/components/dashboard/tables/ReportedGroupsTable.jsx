...
function ReportedGroupsTable() {
  ...
  return (
    <div>
      <div className="mt-5">
        <h1 className="p-2 font-semibold text-lg">Reported Groups </h1>
                          ...
                          return (
                            <tr key={index}>
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
                                {reportedGrpData.groupName}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
                                <a className="text-black" href={reportedGrpData.groupLink} target="_blank" rel="noopener noreferrer">
                                  {reportedGrpData.groupLink}
                                </a>
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
                                {reportedGrpData.country}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
                                {reportedGrpData.Language}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
                                {reportedGrpData.Category.catName}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
                                {reportedGrpData.Application.appName}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
                                {reportedGrpData.Reports.length}
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
                                <button
                                  className="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
                                  onClick={() => handleClickOpen(reportedGrpData.groupId, 'soft')}
                                >
                                  Remove
                                </button>
                                <button
                                  className="text-white bg-gradient-to-r from-red-700 via-red-800 to-red-900 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2"
                                  onClick={() => handleClickOpen(reportedGrpData.groupId, 'hard')}
                                >
                                  Hard Delete
                                </button>
                                <Dialog
...
export default ReportedGroupsTable;
