...
function AllGroupsTable() {
  ...
  return (
    <div>
      <div className="mt-5">
        <h1 className="p-2 font-semibold text-lg">All Groups</h1>
                        ...
                        .map((allgroup, index) => {
                          ...
                          return (
                            <tr key={index}>
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
                                <a className="text-black" href={`${allgroup.groupLink}`} target="_blank" rel="noopener noreferrer">
                                  {allgroup.groupLink}
                                </a>
                              </td>
                              <td className="px-6 py-4 whitespace-nowrap text-sm text-black">
